...
class ReceitaWriterTest {
    ...
    public void writeTest() throws Exception {
        ...
        boolean contains = isContains(file, "0001;12345-6;152,61;A;processado");
    ...
    private List<ReceitaDTO> createReceitaDTO() {
        ...
        list.add(ReceitaDTO.builder().agencia("0001").conta("12345-6").saldo(152.61).status("A").resultado("processado").build());
        list.add(ReceitaDTO.builder().agencia("0001").conta("12335-7").saldo(120.18).status("A").resultado("processado").build());
        list.add(ReceitaDTO.builder().agencia("0001").conta("13345-6").saldo(1458.89).status("A").resultado("processado").build());
        list.add(ReceitaDTO.builder().agencia("0001").conta("12345-8").saldo(10586.74).status("I").resultado("processado").build());
        return list;
    }
}